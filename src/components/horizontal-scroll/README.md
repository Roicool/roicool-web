...
| `data-rc-scrub`     | saniye, `0.3`       | Satırın scroll'u yakalama gecikmesi; `0` birebir       |
| `data-rc-eager`     | —                   | Görünüre girmeyi beklemeden yükle                      |

## Hareket

- İki evre: section alttan görünüre girerken satır mesafenin dörtte birini
  (en fazla viewport'un %20'si) yavaşça alır; stage tepeye gelince pin başlar
  ve kalan mesafe scroll ile 1:1 gider. Pin anında satır zaten hareket
  halindedir, duruş değil devam hissi verir.
- Scrub: easing yok; scroll'u 0.3 s gecikmeyle yakalar (`data-rc-scrub`),
  kalkış ve duruşlar yuvarlanır. Lenis'in yumuşatması bunun üstüne gelir.
- Pin: hero ile aynı ScrollTrigger; Lenis'e bağlı, `ignoreMobileResize`.
- Section'a üst padding verme; pin stage'in tepeye değdiği anda başlar,
  section padding'i o anı aşağı kaydırır. Boşluğu stage'in içine ver.
